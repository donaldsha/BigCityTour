...
public class CityFragment extends Fragment {
    ...
    public void extractCityDetails() {
        ...
        for (City ct : cityRecord) {
            mCountry = ct.getCityCountry().trim();
            mLanguage = ct.getCityLanguage().trim();
            mAirport = ct.getCityAirport().trim();
            mTransport = ct.getCityTransport().trim();
            mAboutCity = ct.getCityShortDesc().trim();
